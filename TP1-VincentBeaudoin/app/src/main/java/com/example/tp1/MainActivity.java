    ...
    private class Ecouteur implements View.OnClickListener{
        ...
        public void onClick(View v) {
            if(v == playPauseButton){
                ...
                Musique musique = (Musique) vectorChanson.get(10);
                String chanson = musique.getChanson();

                MediaItem mediaItem = MediaItem.fromUri(Uri.parse(chanson));
